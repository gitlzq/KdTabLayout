...
import ki.zq.tablayout.utils.SlidingAdapter;
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    static class InnerPagerAdapter extends SlidingAdapter {
        private ArrayList<Fragment> fragments;
        private String[] titles;

        public InnerPagerAdapter(FragmentActivity fa, ArrayList<Fragment> fragments, String[] titles) {
            super(fa);
