...
import ki.zq.tablayout.listener.OnTabSelectListener;
import ki.zq.tablayout.utils.FragmentChangeManager;
import ki.zq.tablayout.utils.UnreadMsgUtils;
import ki.zq.tablayout.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    /** 关联数据支持同时切换fragments */
    public void setTabData(ArrayList<CustomTabEntity> tabEntices, FragmentActivity fa, int containerViewId, ArrayList<Fragment> fragments) {
        mFragmentChangeManager = new FragmentChangeManager(fa.getSupportFragmentManager(), containerViewId, fragments);
        setTabData(tabEntices);
    }
